...
public sealed class PostgresDapperModuleSession(NpgsqlDataSource dataSource)
    : IPostgresDapperModuleSession, IAsyncDisposable
{
    ...
    public NpgsqlConnection Connection =>
        _connection ?? throw new InvalidOperationException(
            "PostgreSQL Dapper module session has not been opened.");
