...
internal sealed class PostgresDapperModuleTransactionRunner(
        ...
        CancellationToken ct)
    {
        ...
        if (!module.UsesPersistence
            || !StringComparer.Ordinal.Equals(
                ...
                PostgresDapperModulePersistence.ProviderName))
        {
            await next(ct);
            return;
        }

        IPostgresDapperModuleSession session = _serviceProvider
            .GetRequiredService<IPostgresDapperModuleSession>();
