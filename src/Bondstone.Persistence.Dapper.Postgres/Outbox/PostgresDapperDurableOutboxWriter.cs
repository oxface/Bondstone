...
public sealed class PostgresDapperDurableOutboxWriter(
...
public sealed class PostgresDapperModuleDurableOutboxWriter(
    string moduleName,
    IPostgresDapperModuleSession session,
    TimeProvider? timeProvider = null,
    string? schema = null)
...
{
    private readonly PostgresDapperDurableOutboxWriter _writer = new(
        session,
        timeProvider,
        schema);
