...
internal static class RebusDurableEnvelopeMapper
{
    public static RebusDurableMessageEnvelope CreateEnvelope(
        DurableMessageEnvelope envelope)
    {
        return RebusDurableMessageEnvelope.From(envelope);
    }
