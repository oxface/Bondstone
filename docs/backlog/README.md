...
- [01-adr-application-audit.md](01-adr-application-audit.md) audits active ADRs
  and resolves unapplied, deferred, obsolete, or superseded decisions.
- [02-documentation-tightening.md](02-documentation-tightening.md) cleans the
  MVP-era documentation into durable current-state documentation.
