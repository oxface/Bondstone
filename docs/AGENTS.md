...
This folder contains stable docs and ADRs.
...
Keep stable docs as the current operating contract. Keep ADRs as the decision
trail. Track backlog work in GitHub Issues or GitHub Projects. Use local README
and AGENTS files as indexes into those docs rather than as duplicate rule
stores.
